...
<el-card class="box-card">
  ...
  <el-form-item>
    <el-button type="primary" @click="Landing('ruleForm')">立即登录</el-button>
    <el-button @click="Register('ruleForm')">立即注册</el-button>
  </el-form-item>
</el-form>
 </div>
</el-card>
     ...
     return {
      ruleForm: {
        ...
        rules: {
          ...
          inputPass: [
            { validator: inputPass, trigger: 'blur' }
          ],
          inputCode: [
            { validator: inputCode, trigger: 'blur' }
          ]
        }
     }
   },
