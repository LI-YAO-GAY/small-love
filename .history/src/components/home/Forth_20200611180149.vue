      ...
      <el-card class="m-lr-20 f1">
        ...
        <div class="content">
          ...
          <div class="flex a-center m-b-10">
           <div v-if="todolist.slice(todolist.length-1,todolist.length+1)"> <input type="checkbox" class='Ipt' checked="checked"></div>
           <div v-if="todolist.slice(todolist.length-1,todolist.length+1)"> <input type="checkbox" class='Ipt'></div>
