      ...
      <el-card class="m-lr-20 f1">
        ...
        <div class="content">
          <div v-for="(item,index) in todolist" :key="index">
            ...
            <div class='circle flex a-center j-center'>
            <div v-if="item.tick === true"><i class="el-icon-check" @click="CheckItem(item)"></i></div>
            </div>
        ...
        <div class="flex F12 j-around">
          ...
          <div>
            <input type="text" value="All" class="ALL" @change="ChangeItem" />
          </div>
          <div>Active</div>
          <div>Completed</div>
        </div>
...
export default {
  ...
  methods: {
    ...
    ChangeItem(){
    // item.checked = item.every(function(item1){
