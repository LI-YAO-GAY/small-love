      ...
      <el-card class="m-lr-20 f1">
        ...
        <div class="content">
          ...
          <div class="flex a-center m-b-10">
           <div v-if="id===7"> <input type="checkbox" class='Ipt' checked="checked"></div>
           <div v-if="id===7"> <input type="checkbox" class='Ipt'></div>
...
export default {
  ...
  data() {
    return {
      ...
      progress: [],
      todolist:[
        {name:'star this repository',id:"1"},
        {name:'fork this repository',id:"2"},
        {name:'follow author',id:"3"},
        {name:'vue-admin',id:"4"},
        {name:'vue',id:"5"},
        {name:'element-ui',id:"6"},
        {name:'axios',id:"7"},
        {name:'webpack',id:"8"},
      ]
    };
