      ...
      <el-card class="m-lr-20 f1">
        ...
        <div class="content">
          ...
          <div class="flex a-center m-b-10">
           <div v-if="todolist.length > 0"> <input type="checkbox" class='Ipt' checked="checked"></div>
           <div v-if="todolist.length > 0 && todolist.length <= 6"> <input type="checkbox" class='Ipt'></div>
