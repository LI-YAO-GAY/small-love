      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane :label="`回收站(${count})`" name="third">
          <div class="read">
            ...
            <el-button type="primary" class="readALL"  @click="BeforelALL(scope.$index, scope.row)">删除全部</el-button>
          </div>
        </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    Flagread(index,row) {
     ...
     if (JSON.stringify(this.tableData2).indexOf(JSON.stringify(this.tableData)) == -1) {
		this.yxqyData.push(this.tableData);
	}
